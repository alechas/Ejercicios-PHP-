...
class AccesoDatos
{
    ...
    private function __construct()
    {
        try { 
            ...
            // Local
            $this->objetoPDO = new PDO('mysql:host=localhost;dbname=mercaderia;charset=utf8', 'alechas', 'Lalala123', array(PDO::ATTR_EMULATE_PREPARES => false,PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
